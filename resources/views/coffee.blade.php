...
<header class="masthead">
    <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
            <h1 class="mx-auto my-0 text-uppercase">Cofe</h1>
            <h2 class="text-white-50 mx-auto mt-2 mb-5">想要來一杯香濃的咖啡嗎？事不宜遲立刻點擊下方進行挑選</h2>
            <a href="#about" class="btn btn-primary js-scroll-trigger">查看產品</a>
        </div>
    </div>
</header>
